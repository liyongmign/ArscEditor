...
package com.mly.arsc.decode.io;

import java.io.File;
import java.io.IOException;
import java.io.RandomAccessFile;

public class LEDataOutputStream2 {
    /**
     * 二进制文件输出流
     */
     ...
     * 构造函数
     */
    public LEDataOutputStream2(File out, int chunkSize) throws IOException {
        this.raf = new RandomAccessFile(out, "rw");
        this.raf.setLength(chunkSize);
    }
    ...
    public void writeInt(int i) throws IOException {
        raf.writeByte(i & 0xff);
        raf.writeByte((i >> 8) & 0xff);
        raf.writeByte((i >> 16) & 0xff);
        raf.writeByte((i >> 24) & 0xff);
    }
    ...
    public void writeShort(short s) throws IOException {
        raf.writeByte(s & 0xff);
        raf.writeByte((s >>> 8) & 0xff);
    }
}
